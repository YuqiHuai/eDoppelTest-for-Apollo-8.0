...
from ....modules.common_msgs.basic_msgs import (
    direction_pb2 as modules_dot_common__msgs_dot_basic__msgs_dot_direction__pb2,
)
from ....modules.common_msgs.basic_msgs import (
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="modules/common_msgs/v2x_msgs/v2x_traffic_light.proto",
    package="apollo.v2x",
    syntax="proto2",
    ...
    dependencies=[
        ...
        modules_dot_common__msgs_dot_basic__msgs_dot_direction__pb2.DESCRIPTOR,
    ],
)
...
_SINGLETRAFFICLIGHT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.SingleTrafficLight.traffic_light_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.v2x.SingleTrafficLight.id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.SingleTrafficLight.color_remaining_time_s",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.SingleTrafficLight.right_turn_light",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="next_color",
            full_name="apollo.v2x.SingleTrafficLight.next_color",
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="next_remaining_time_s",
            full_name="apollo.v2x.SingleTrafficLight.next_remaining_time_s",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_SINGLETRAFFICLIGHT_COLOR, _SINGLETRAFFICLIGHT_TYPE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_ROADTRAFFICLIGHT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="gps_x_m",
            full_name="apollo.v2x.RoadTrafficLight.gps_x_m",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="gps_y_m",
            full_name="apollo.v2x.RoadTrafficLight.gps_y_m",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.RoadTrafficLight.single_traffic_light",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="road_attribute",
            full_name="apollo.v2x.RoadTrafficLight.road_attribute",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_INTERSECTIONTRAFFICLIGHTDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.v2x.IntersectionTrafficLightData.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.IntersectionTrafficLightData.road_traffic_light",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.v2x.IntersectionTrafficLightData.intersection_id",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="confidence",
            full_name="apollo.v2x.IntersectionTrafficLightData.confidence",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_SINGLETRAFFICLIGHT.fields_by_name[
    "traffic_light_type"
].enum_type = _SINGLETRAFFICLIGHT_TYPE
...
_ROADTRAFFICLIGHT.fields_by_name[
    "single_traffic_light"
].message_type = _SINGLETRAFFICLIGHT
_ROADTRAFFICLIGHT.fields_by_name[
    "road_attribute"
].enum_type = modules_dot_common__msgs_dot_basic__msgs_dot_direction__pb2._DIRECTION
_INTERSECTIONTRAFFICLIGHTDATA.fields_by_name[
    "header"
].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INTERSECTIONTRAFFICLIGHTDATA.fields_by_name[
    "road_traffic_light"
].message_type = _ROADTRAFFICLIGHT
...
IntersectionTrafficLightData = _reflection.GeneratedProtocolMessageType(
    "IntersectionTrafficLightData",
    (_message.Message,),
    {
