...
_LANEOVERLAPINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="start_s",
            full_name="apollo.hdmap.LaneOverlapInfo.start_s",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="end_s",
            full_name="apollo.hdmap.LaneOverlapInfo.end_s",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="is_merge",
            full_name="apollo.hdmap.LaneOverlapInfo.is_merge",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="region_overlap_id",
            full_name="apollo.hdmap.LaneOverlapInfo.region_overlap_id",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_CROSSWALKOVERLAPINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="region_overlap_id",
            full_name="apollo.hdmap.CrosswalkOverlapInfo.region_overlap_id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_REGIONOVERLAPINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.hdmap.RegionOverlapInfo.id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="polygon",
            full_name="apollo.hdmap.RegionOverlapInfo.polygon",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_OBJECTOVERLAPINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.hdmap.ObjectOverlapInfo.id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="lane_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.lane_overlap_info",
            index=1,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="signal_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.signal_overlap_info",
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="stop_sign_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.stop_sign_overlap_info",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="crosswalk_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.crosswalk_overlap_info",
            index=4,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="junction_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.junction_overlap_info",
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="yield_sign_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.yield_sign_overlap_info",
            index=6,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="clear_area_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.clear_area_overlap_info",
            index=7,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="speed_bump_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.speed_bump_overlap_info",
            index=8,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="parking_space_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.parking_space_overlap_info",
            index=9,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="pnc_junction_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.pnc_junction_overlap_info",
            index=10,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rsu_overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.rsu_overlap_info",
            index=11,
            number=13,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="overlap_info",
            full_name="apollo.hdmap.ObjectOverlapInfo.overlap_info",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_OVERLAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.hdmap.Overlap.id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="object",
            full_name="apollo.hdmap.Overlap.object",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="region_overlap",
            full_name="apollo.hdmap.Overlap.region_overlap",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_LANEOVERLAPINFO.fields_by_name[
    "region_overlap_id"
].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_CROSSWALKOVERLAPINFO.fields_by_name[
    "region_overlap_id"
].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_REGIONOVERLAPINFO.fields_by_name[
    "id"
].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_REGIONOVERLAPINFO.fields_by_name[
    "polygon"
].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
_OBJECTOVERLAPINFO.fields_by_name[
    "id"
].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_OBJECTOVERLAPINFO.fields_by_name["lane_overlap_info"].message_type = _LANEOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "signal_overlap_info"
].message_type = _SIGNALOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "stop_sign_overlap_info"
].message_type = _STOPSIGNOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "crosswalk_overlap_info"
].message_type = _CROSSWALKOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "junction_overlap_info"
].message_type = _JUNCTIONOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "yield_sign_overlap_info"
].message_type = _YIELDOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "clear_area_overlap_info"
].message_type = _CLEARAREAOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "speed_bump_overlap_info"
].message_type = _SPEEDBUMPOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "parking_space_overlap_info"
].message_type = _PARKINGSPACEOVERLAPINFO
_OBJECTOVERLAPINFO.fields_by_name[
    "pnc_junction_overlap_info"
].message_type = _PNCJUNCTIONOVERLAPINFO
...
_OBJECTOVERLAPINFO.fields_by_name[
    "lane_overlap_info"
].containing_oneof = _OBJECTOVERLAPINFO.oneofs_by_name["overlap_info"]
_OBJECTOVERLAPINFO.oneofs_by_name["overlap_info"].fields.append(
...
LaneOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "LaneOverlapInfo",
    (_message.Message,),
    {
...
SignalOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "SignalOverlapInfo",
    (_message.Message,),
    {
...
StopSignOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "StopSignOverlapInfo",
    (_message.Message,),
    {
...
CrosswalkOverlapInfo = _reflection.GeneratedProtocolMessageType(
...
JunctionOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "JunctionOverlapInfo",
    (_message.Message,),
    {
...
YieldOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "YieldOverlapInfo",
    (_message.Message,),
    {
...
ClearAreaOverlapInfo = _reflection.GeneratedProtocolMessageType(
...
SpeedBumpOverlapInfo = _reflection.GeneratedProtocolMessageType(
...
ParkingSpaceOverlapInfo = _reflection.GeneratedProtocolMessageType(
...
PNCJunctionOverlapInfo = _reflection.GeneratedProtocolMessageType(
...
RSUOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "RSUOverlapInfo",
    (_message.Message,),
    {
...
RegionOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "RegionOverlapInfo",
    (_message.Message,),
    {
...
ObjectOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "ObjectOverlapInfo",
    (_message.Message,),
    {
...
Overlap = _reflection.GeneratedProtocolMessageType(
    "Overlap",
    (_message.Message,),
    {
        "DESCRIPTOR": _OVERLAP,
