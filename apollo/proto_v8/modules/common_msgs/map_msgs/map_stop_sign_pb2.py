...
StopSign = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "modules.common_msgs.map_msgs.map_stop_sign_pb2",
    },
)
