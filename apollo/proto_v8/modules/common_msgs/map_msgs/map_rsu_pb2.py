...
RSU = _reflection.GeneratedProtocolMessageType(
    "RSU",
    (_message.Message,),
    {"DESCRIPTOR": _RSU, "__module__": "modules.common_msgs.map_msgs.map_rsu_pb2"},
)
