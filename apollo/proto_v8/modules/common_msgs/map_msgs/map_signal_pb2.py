...
Subsignal = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "modules.common_msgs.map_msgs.map_signal_pb2",
    },
)
