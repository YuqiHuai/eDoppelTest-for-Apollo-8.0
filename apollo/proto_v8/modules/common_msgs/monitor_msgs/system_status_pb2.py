...
_COMPONENTSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="apollo.monitor.ComponentStatus.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_COMPONENTSTATUS_STATUS],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_COMPONENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="summary",
            full_name="apollo.monitor.Component.summary",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="process_status",
            full_name="apollo.monitor.Component.process_status",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="channel_status",
            full_name="apollo.monitor.Component.channel_status",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.monitor.Component.resource_status",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="other_status",
            full_name="apollo.monitor.Component.other_status",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="module_status",
            full_name="apollo.monitor.Component.module_status",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
_SYSTEMSTATUS_HMIMODULESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.monitor.SystemStatus.HmiModulesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.monitor.SystemStatus.HmiModulesEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SYSTEMSTATUS_COMPONENTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.monitor.SystemStatus.ComponentsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.monitor.SystemStatus.ComponentsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SYSTEMSTATUS_OTHERCOMPONENTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.monitor.SystemStatus.OtherComponentsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.monitor.SystemStatus.OtherComponentsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SYSTEMSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.monitor.SystemStatus.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="hmi_modules",
            full_name="apollo.monitor.SystemStatus.hmi_modules",
            index=1,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="components",
            full_name="apollo.monitor.SystemStatus.components",
            index=2,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="passenger_msg",
            full_name="apollo.monitor.SystemStatus.passenger_msg",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="safety_mode_trigger_time",
            full_name="apollo.monitor.SystemStatus.safety_mode_trigger_time",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="require_emergency_stop",
            full_name="apollo.monitor.SystemStatus.require_emergency_stop",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="is_realtime_in_simulation",
            full_name="apollo.monitor.SystemStatus.is_realtime_in_simulation",
            index=6,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.monitor.SystemStatus.other_components",
            index=7,
            number=10,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _SYSTEMSTATUS_HMIMODULESENTRY,
        _SYSTEMSTATUS_COMPONENTSENTRY,
        _SYSTEMSTATUS_OTHERCOMPONENTSENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_SYSTEMSTATUS_OTHERCOMPONENTSENTRY.fields_by_name[
    "value"
].message_type = _COMPONENTSTATUS
_SYSTEMSTATUS_OTHERCOMPONENTSENTRY.containing_type = _SYSTEMSTATUS
_SYSTEMSTATUS.fields_by_name[
    "header"
...
_SYSTEMSTATUS.fields_by_name[
    "other_components"
].message_type = _SYSTEMSTATUS_OTHERCOMPONENTSENTRY
...
ComponentStatus = _reflection.GeneratedProtocolMessageType(
    "ComponentStatus",
    (_message.Message,),
    {
...
SystemStatus = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "HmiModulesEntry": _reflection.GeneratedProtocolMessageType(
            "HmiModulesEntry",
            (_message.Message,),
            {
        ...
        "ComponentsEntry": _reflection.GeneratedProtocolMessageType(
            "ComponentsEntry",
            (_message.Message,),
            {
