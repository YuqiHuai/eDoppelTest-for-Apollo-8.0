...
_MONITORMESSAGEITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="source",
            full_name="apollo.common.monitor.MonitorMessageItem.source",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="apollo.common.monitor.MonitorMessageItem.msg",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="log_level",
            full_name="apollo.common.monitor.MonitorMessageItem.log_level",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_MONITORMESSAGEITEM_MESSAGESOURCE, _MONITORMESSAGEITEM_LOGLEVEL],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_MONITORMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.common.monitor.MonitorMessage.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="item",
            full_name="apollo.common.monitor.MonitorMessage.item",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MONITORMESSAGEITEM.fields_by_name[
    "source"
].enum_type = _MONITORMESSAGEITEM_MESSAGESOURCE
...
_MONITORMESSAGE.fields_by_name[
    "header"
...
MonitorMessageItem = _reflection.GeneratedProtocolMessageType(
    "MonitorMessageItem",
    (_message.Message,),
    {
...
MonitorMessage = _reflection.GeneratedProtocolMessageType(
    "MonitorMessage",
    (_message.Message,),
    {
