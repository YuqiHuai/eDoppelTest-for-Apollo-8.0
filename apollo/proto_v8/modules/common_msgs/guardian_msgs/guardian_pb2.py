...
from ....modules.common_msgs.control_msgs import (
    control_cmd_pb2 as modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2,
)

DESCRIPTOR = _descriptor.FileDescriptor(
    name="modules/common_msgs/guardian_msgs/guardian.proto",
    package="apollo.guardian",
    syntax="proto2",
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
    serialized_pb=b'\n0modules/common_msgs/guardian_msgs/guardian.proto\x12\x0fapollo.guardian\x1a+modules/common_msgs/basic_msgs/header.proto\x1a2modules/common_msgs/control_msgs/control_cmd.proto"q\n\x0fGuardianCommand\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x127\n\x0fcontrol_command\x18\x02 \x01(\x0b2\x1e.apollo.control.ControlCommand',
    dependencies=[
        modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,
        modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2.DESCRIPTOR,
    ],
)
...
_GUARDIANCOMMAND.fields_by_name[
    ...
    modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2._CONTROLCOMMAND
)
