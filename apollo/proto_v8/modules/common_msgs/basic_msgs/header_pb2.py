...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="modules/common_msgs/basic_msgs/header.proto",
...
_HEADER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp_sec",
            full_name="apollo.common.Header.timestamp_sec",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="module_name",
            full_name="apollo.common.Header.module_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="sequence_num",
            full_name="apollo.common.Header.sequence_num",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="lidar_timestamp",
            full_name="apollo.common.Header.lidar_timestamp",
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.common.Header.camera_timestamp",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.common.Header.radar_timestamp",
            index=5,
            number=6,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="version",
            full_name="apollo.common.Header.version",
            index=6,
            number=7,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="apollo.common.Header.status",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="frame_id",
            full_name="apollo.common.Header.frame_id",
            index=8,
            number=9,
            type=9,
            cpp_type=9,
...
Header = _reflection.GeneratedProtocolMessageType(
    "Header",
    (_message.Message,),
    {"DESCRIPTOR": _HEADER, "__module__": "modules.common_msgs.basic_msgs.header_pb2"},
)
