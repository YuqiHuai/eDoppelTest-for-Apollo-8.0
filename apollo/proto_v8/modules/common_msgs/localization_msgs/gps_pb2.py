...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n/modules/common_msgs/localization_msgs/gps.proto\x12\x13apollo.localization\x1a+modules/common_msgs/basic_msgs/header.proto\x1a0modules/common_msgs/localization_msgs/pose.proto"]\n\x03Gps\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x12/\n\x0clocalization\x18\x02 \x01(\x0b2\x19.apollo.localization.Pose',
    dependencies=[
...
_GPS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.localization.Gps.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="localization",
            full_name="apollo.localization.Gps.localization",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
Gps = _reflection.GeneratedProtocolMessageType(
    "Gps",
    (_message.Message,),
    {"DESCRIPTOR": _GPS, "__module__": "modules.common_msgs.localization_msgs.gps_pb2"},
)
