...
_LANDMARK.fields_by_name[
    ...
    modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2._LANEWAYPOINT
)
_LANDMARK.fields_by_name[
    "parking_info"
].message_type = (
    modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2._PARKINGINFO
)
...
Landmark = _reflection.GeneratedProtocolMessageType(
    "Landmark",
    (_message.Message,),
    {"DESCRIPTOR": _LANDMARK, "__module__": "modules.common_msgs.routing_msgs.poi_pb2"},
)
_sym_db.RegisterMessage(Landmark)
POI = _reflection.GeneratedProtocolMessageType(
    "POI",
    (_message.Message,),
    {"DESCRIPTOR": _POI, "__module__": "modules.common_msgs.routing_msgs.poi_pb2"},
)
