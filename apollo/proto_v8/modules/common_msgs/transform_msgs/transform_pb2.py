...
_TRANSFORM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="translation",
            full_name="apollo.transform.Transform.translation",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rotation",
            full_name="apollo.transform.Transform.rotation",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_TRANSFORMSTAMPED = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.transform.TransformStamped.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="child_frame_id",
            full_name="apollo.transform.TransformStamped.child_frame_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="transform",
            full_name="apollo.transform.TransformStamped.transform",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_TRANSFORMSTAMPEDS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.transform.TransformStampeds.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transforms",
            full_name="apollo.transform.TransformStampeds.transforms",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_TRANSFORMSTAMPED.fields_by_name[
    "header"
...
_TRANSFORMSTAMPEDS.fields_by_name[
    "header"
].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
...
Transform = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "modules.common_msgs.transform_msgs.transform_pb2",
    },
)
_sym_db.RegisterMessage(Transform)
TransformStamped = _reflection.GeneratedProtocolMessageType(
    "TransformStamped",
    (_message.Message,),
    {
...
TransformStampeds = _reflection.GeneratedProtocolMessageType(
    "TransformStampeds",
    (_message.Message,),
    {
