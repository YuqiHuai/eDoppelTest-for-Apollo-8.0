...
_TRAFFICLIGHT = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_TRAFFICLIGHT_COLOR],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_TRAFFICLIGHTDETECTION = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_TRAFFICLIGHTDETECTION_CAMERAID],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
TrafficLightBox = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "modules.common_msgs.perception_msgs.traffic_light_detection_pb2",
    },
)
