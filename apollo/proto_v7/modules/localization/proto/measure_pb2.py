...
_INTEGMEASURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.localization.IntegMeasure.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="measure_type",
            full_name="apollo.localization.IntegMeasure.measure_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="frame_type",
            full_name="apollo.localization.IntegMeasure.frame_type",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="position",
            full_name="apollo.localization.IntegMeasure.position",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="velocity",
            full_name="apollo.localization.IntegMeasure.velocity",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="yaw",
            full_name="apollo.localization.IntegMeasure.yaw",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="zone_id",
            full_name="apollo.localization.IntegMeasure.zone_id",
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="is_have_variance",
            full_name="apollo.localization.IntegMeasure.is_have_variance",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="is_gnss_double_antenna",
            full_name="apollo.localization.IntegMeasure.is_gnss_double_antenna",
            index=8,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="measure_covar",
            full_name="apollo.localization.IntegMeasure.measure_covar",
            index=9,
            number=10,
            type=1,
            cpp_type=5,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_INTEGMEASURE_MEASURETYPE, _INTEGMEASURE_FRAMETYPE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
IntegMeasure = _reflection.GeneratedProtocolMessageType(
    "IntegMeasure",
    (_message.Message,),
    {
