...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n$modules/localization/proto/gps.proto\x12\x13apollo.localization\x1a!modules/common/proto/header.proto\x1a%modules/localization/proto/pose.proto"]\n\x03Gps\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x12/\n\x0clocalization\x18\x02 \x01(\x0b2\x19.apollo.localization.Pose',
    dependencies=[
...
Gps = _reflection.GeneratedProtocolMessageType(
    "Gps",
    (_message.Message,),
    {"DESCRIPTOR": _GPS, "__module__": "modules.localization.proto.gps_pb2"},
)
