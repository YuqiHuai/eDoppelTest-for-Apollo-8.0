...
_BOUNDINGBOX2D = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="apollo.contrib.lgsvl_msgs.BoundingBox2D.x",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="apollo.contrib.lgsvl_msgs.BoundingBox2D.y",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="apollo.contrib.lgsvl_msgs.BoundingBox2D.width",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="apollo.contrib.lgsvl_msgs.BoundingBox2D.height",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_VECTOR3 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="apollo.contrib.lgsvl_msgs.Vector3.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="apollo.contrib.lgsvl_msgs.Vector3.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="z",
            full_name="apollo.contrib.lgsvl_msgs.Vector3.z",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_TWIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="linear",
            full_name="apollo.contrib.lgsvl_msgs.Twist.linear",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="angular",
            full_name="apollo.contrib.lgsvl_msgs.Twist.angular",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_DETECTION2D = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.id",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.label",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="score",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.score",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="bbox",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.bbox",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="velocity",
            full_name="apollo.contrib.lgsvl_msgs.Detection2D.velocity",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
BoundingBox2D = _reflection.GeneratedProtocolMessageType(
    "BoundingBox2D",
    (_message.Message,),
    {
...
Twist = _reflection.GeneratedProtocolMessageType(
    "Twist",
    (_message.Message,),
    {
        "DESCRIPTOR": _TWIST,
...
Detection2D = _reflection.GeneratedProtocolMessageType(
    "Detection2D",
    (_message.Message,),
    {
