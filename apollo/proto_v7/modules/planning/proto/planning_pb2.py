...
EStop = _reflection.GeneratedProtocolMessageType(
    "EStop",
    (_message.Message,),
    {"DESCRIPTOR": _ESTOP, "__module__": "modules.planning.proto.planning_pb2"},
)
_sym_db.RegisterMessage(EStop)
TaskStats = _reflection.GeneratedProtocolMessageType(
    "TaskStats",
    (_message.Message,),
    {"DESCRIPTOR": _TASKSTATS, "__module__": "modules.planning.proto.planning_pb2"},
)
_sym_db.RegisterMessage(TaskStats)
LatencyStats = _reflection.GeneratedProtocolMessageType(
    "LatencyStats",
    (_message.Message,),
    {"DESCRIPTOR": _LATENCYSTATS, "__module__": "modules.planning.proto.planning_pb2"},
)
_sym_db.RegisterMessage(LatencyStats)
RSSInfo = _reflection.GeneratedProtocolMessageType(
    "RSSInfo",
    (_message.Message,),
    {"DESCRIPTOR": _RSSINFO, "__module__": "modules.planning.proto.planning_pb2"},
)
