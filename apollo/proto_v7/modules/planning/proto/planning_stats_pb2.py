...
_STATSGROUP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="max",
            full_name="apollo.planning.StatsGroup.max",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="min",
            full_name="apollo.planning.StatsGroup.min",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="sum",
            full_name="apollo.planning.StatsGroup.sum",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="avg",
            full_name="apollo.planning.StatsGroup.avg",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="num",
            full_name="apollo.planning.StatsGroup.num",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_PLANNINGSTATS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.planning.PlanningStats.total_path_length",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.planning.PlanningStats.total_path_time",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="v",
            full_name="apollo.planning.PlanningStats.v",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="a",
            full_name="apollo.planning.PlanningStats.a",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="kappa",
            full_name="apollo.planning.PlanningStats.kappa",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="dkappa",
            full_name="apollo.planning.PlanningStats.dkappa",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
StatsGroup = _reflection.GeneratedProtocolMessageType(
    "StatsGroup",
    (_message.Message,),
    {
...
PlanningStats = _reflection.GeneratedProtocolMessageType(
    "PlanningStats",
    (_message.Message,),
    {
