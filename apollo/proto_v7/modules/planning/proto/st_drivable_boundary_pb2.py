...
_STDRIVABLEBOUNDARYINSTANCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="t",
            full_name="apollo.planning.STDrivableBoundaryInstance.t",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="s_lower",
            full_name="apollo.planning.STDrivableBoundaryInstance.s_lower",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="s_upper",
            full_name="apollo.planning.STDrivableBoundaryInstance.s_upper",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="v_obs_lower",
            full_name="apollo.planning.STDrivableBoundaryInstance.v_obs_lower",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="v_obs_upper",
            full_name="apollo.planning.STDrivableBoundaryInstance.v_obs_upper",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
...
_STDRIVABLEBOUNDARY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="st_boundary",
            full_name="apollo.planning.STDrivableBoundary.st_boundary",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_STDRIVABLEBOUNDARY.fields_by_name[
    "st_boundary"
].message_type = _STDRIVABLEBOUNDARYINSTANCE
DESCRIPTOR.message_types_by_name[
    "STDrivableBoundaryInstance"
] = _STDRIVABLEBOUNDARYINSTANCE
DESCRIPTOR.message_types_by_name["STDrivableBoundary"] = _STDRIVABLEBOUNDARY
_sym_db.RegisterFileDescriptor(DESCRIPTOR)
STDrivableBoundaryInstance = _reflection.GeneratedProtocolMessageType(
    "STDrivableBoundaryInstance",
    (_message.Message,),
    {
...
STDrivableBoundary = _reflection.GeneratedProtocolMessageType(
    "STDrivableBoundary",
    (_message.Message,),
    {
