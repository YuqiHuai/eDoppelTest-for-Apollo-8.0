...
_OBURSI = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.v2x.obu.ObuRsi.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rsu_id",
            full_name="apollo.v2x.obu.ObuRsi.rsu_id",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="rsi_id",
            full_name="apollo.v2x.obu.ObuRsi.rsi_id",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="alter_type",
            full_name="apollo.v2x.obu.ObuRsi.alter_type",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="description",
            full_name="apollo.v2x.obu.ObuRsi.description",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ref_point",
            full_name="apollo.v2x.obu.ObuRsi.ref_point",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="points",
            full_name="apollo.v2x.obu.ObuRsi.points",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="radius",
            full_name="apollo.v2x.obu.ObuRsi.radius",
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="msg_cnt",
            full_name="apollo.v2x.obu.ObuRsi.msg_cnt",
            index=8,
            number=9,
            type=5,
            cpp_type=1,
...
ObuRsi = _reflection.GeneratedProtocolMessageType(
    "ObuRsi",
    (_message.Message,),
    {"DESCRIPTOR": _OBURSI, "__module__": "modules.v2x.proto.v2x_obu_rsi_pb2"},
)
