...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        modules_dot_canbus_dot_proto_dot_chassis__detail__pb2.DESCRIPTOR,
        modules_dot_v2x_dot_proto_dot_v2x__junction__pb2.DESCRIPTOR,
    ],
)
_CARSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="localization",
            full_name="apollo.v2x.CarStatus.localization",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="chassis_detail",
            full_name="apollo.v2x.CarStatus.chassis_detail",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="junction",
            full_name="apollo.v2x.CarStatus.junction",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rsu_id",
            full_name="apollo.v2x.CarStatus.rsu_id",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_CARSTATUS.fields_by_name[
    "chassis_detail"
].message_type = modules_dot_canbus_dot_proto_dot_chassis__detail__pb2._CHASSISDETAIL
_CARSTATUS.fields_by_name[
    "junction"
].message_type = modules_dot_v2x_dot_proto_dot_v2x__junction__pb2._JUNCTION
_CARSTATUS.fields_by_name[
    "rsu_id"
].message_type = modules_dot_v2x_dot_proto_dot_v2x__junction__pb2._ID
DESCRIPTOR.message_types_by_name["CarStatus"] = _CARSTATUS
_sym_db.RegisterFileDescriptor(DESCRIPTOR)
CarStatus = _reflection.GeneratedProtocolMessageType(
    "CarStatus",
    (_message.Message,),
    {"DESCRIPTOR": _CARSTATUS, "__module__": "modules.v2x.proto.v2x_car_status_pb2"},
)
