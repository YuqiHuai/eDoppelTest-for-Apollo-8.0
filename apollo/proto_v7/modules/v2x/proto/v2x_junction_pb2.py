...
_JUNCTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.v2x.Junction.id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="polygon",
            full_name="apollo.v2x.Junction.polygon",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="crosswalk_id",
            full_name="apollo.v2x.Junction.crosswalk_id",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="overlap_id",
            full_name="apollo.v2x.Junction.overlap_id",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="num_road_segments",
            full_name="apollo.v2x.Junction.num_road_segments",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="lane_id",
            full_name="apollo.v2x.Junction.lane_id",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="edge_type",
            full_name="apollo.v2x.Junction.edge_type",
            index=7,
            number=8,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_JUNCTION_TYPE, _JUNCTION_EDGETYPE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
Id = _reflection.GeneratedProtocolMessageType(
    "Id",
    (_message.Message,),
    {"DESCRIPTOR": _ID, "__module__": "modules.v2x.proto.v2x_junction_pb2"},
)
_sym_db.RegisterMessage(Id)
Junction = _reflection.GeneratedProtocolMessageType(
    "Junction",
    (_message.Message,),
    {"DESCRIPTOR": _JUNCTION, "__module__": "modules.v2x.proto.v2x_junction_pb2"},
)
