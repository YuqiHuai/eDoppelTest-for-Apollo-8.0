...
_FUSIONCOMPONENTCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="fusion_name",
            full_name="apollo.perception.onboard.FusionComponentConfig.fusion_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            default_value=b"ObstacleMultiSensorFusion".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="fusion_method",
            full_name="apollo.perception.onboard.FusionComponentConfig.fusion_method",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="fusion_main_sensor",
            full_name="apollo.perception.onboard.FusionComponentConfig.fusion_main_sensor",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="object_in_roi_check",
            full_name="apollo.perception.onboard.FusionComponentConfig.object_in_roi_check",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="radius_for_roi_object_check",
            full_name="apollo.perception.onboard.FusionComponentConfig.radius_for_roi_object_check",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.perception.onboard.FusionComponentConfig.output_obstacles_channel_name",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"/perception/vehicle/obstacles".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="output_viz_fused_content_channel_name",
            full_name="apollo.perception.onboard.FusionComponentConfig.output_viz_fused_content_channel_name",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"/perception/inner/visualization/FusedObjects".decode(
                "utf-8"
            ),
            message_type=None,
            enum_type=None,
...
FusionComponentConfig = _reflection.GeneratedProtocolMessageType(
