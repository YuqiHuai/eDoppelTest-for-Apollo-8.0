...
_LIDARDETECTIONCOMPONENTCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sensor_name",
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.sensor_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="detector_name",
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.detector_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="enable_hdmap",
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.enable_hdmap",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="lidar_query_tf_offset",
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.lidar_query_tf_offset",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="lidar2novatel_tf2_child_frame_id",
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.lidar2novatel_tf2_child_frame_id",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.perception.onboard.LidarDetectionComponentConfig.output_channel_name",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
...
_LIDARRECOGNITIONCOMPONENTCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.perception.onboard.LidarRecognitionComponentConfig.main_sensor_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="output_channel_name",
            full_name="apollo.perception.onboard.LidarRecognitionComponentConfig.output_channel_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
] = _LIDARDETECTIONCOMPONENTCONFIG
DESCRIPTOR.message_types_by_name[
    "LidarRecognitionComponentConfig"
] = _LIDARRECOGNITIONCOMPONENTCONFIG
_sym_db.RegisterFileDescriptor(DESCRIPTOR)
LidarDetectionComponentConfig = _reflection.GeneratedProtocolMessageType(
    "LidarDetectionComponentConfig",
    (_message.Message,),
    {
...
LidarRecognitionComponentConfig = _reflection.GeneratedProtocolMessageType(
    "LidarRecognitionComponentConfig",
    (_message.Message,),
    {
