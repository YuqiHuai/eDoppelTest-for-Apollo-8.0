...
_CAMERADSTTYPEFUSIONPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="apollo.perception.fusion.CameraDstTypeFusionParam.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="valid_dist",
            full_name="apollo.perception.fusion.CameraDstTypeFusionParam.valid_dist",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="reliability",
            full_name="apollo.perception.fusion.CameraDstTypeFusionParam.reliability",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="reliability_for_unknown",
            full_name="apollo.perception.fusion.CameraDstTypeFusionParam.reliability_for_unknown",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_LIDARDSTTYPEFUSIONPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="apollo.perception.fusion.LidarDstTypeFusionParam.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="reliability",
            full_name="apollo.perception.fusion.LidarDstTypeFusionParam.reliability",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="reliability_for_unknown",
            full_name="apollo.perception.fusion.LidarDstTypeFusionParam.reliability_for_unknown",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_DSTTYPEFUSIONCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="camera_params",
            full_name="apollo.perception.fusion.DstTypeFusionConfig.camera_params",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="lidar_params",
            full_name="apollo.perception.fusion.DstTypeFusionConfig.lidar_params",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_DSTTYPEFUSIONCONFIG.fields_by_name[
    "camera_params"
].message_type = _CAMERADSTTYPEFUSIONPARAM
_DSTTYPEFUSIONCONFIG.fields_by_name[
    "lidar_params"
].message_type = _LIDARDSTTYPEFUSIONPARAM
...
CameraDstTypeFusionParam = _reflection.GeneratedProtocolMessageType(
...
LidarDstTypeFusionParam = _reflection.GeneratedProtocolMessageType(
...
DstTypeFusionConfig = _reflection.GeneratedProtocolMessageType(
    "DstTypeFusionConfig",
    (_message.Message,),
    {
