...
_SENSORMETA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="apollo.perception.SensorMeta.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="apollo.perception.SensorMeta.type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="orientation",
            full_name="apollo.perception.SensorMeta.orientation",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_SENSORMETA_SENSORTYPE, _SENSORMETA_SENSORORIENTATION],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_MULTISENSORMETA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sensor_meta",
            full_name="apollo.perception.MultiSensorMeta.sensor_meta",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
SensorMeta = _reflection.GeneratedProtocolMessageType(
    "SensorMeta",
    (_message.Message,),
    {
...
MultiSensorMeta = _reflection.GeneratedProtocolMessageType(
    "MultiSensorMeta",
    (_message.Message,),
    {
