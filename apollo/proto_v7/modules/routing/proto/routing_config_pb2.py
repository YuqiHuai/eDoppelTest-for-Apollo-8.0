...
_TOPICCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.routing.TopicConfig.routing_response_topic",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="routing_response_history_topic",
            full_name="apollo.routing.TopicConfig.routing_response_history_topic",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_ROUTINGCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="base_speed",
            full_name="apollo.routing.RoutingConfig.base_speed",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="left_turn_penalty",
            full_name="apollo.routing.RoutingConfig.left_turn_penalty",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="right_turn_penalty",
            full_name="apollo.routing.RoutingConfig.right_turn_penalty",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="uturn_penalty",
            full_name="apollo.routing.RoutingConfig.uturn_penalty",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="change_penalty",
            full_name="apollo.routing.RoutingConfig.change_penalty",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="base_changing_length",
            full_name="apollo.routing.RoutingConfig.base_changing_length",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="topic_config",
            full_name="apollo.routing.RoutingConfig.topic_config",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
