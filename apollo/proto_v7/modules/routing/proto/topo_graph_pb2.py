...
_CURVEPOINT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="s",
            full_name="apollo.routing.CurvePoint.s",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
...
_CURVERANGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="start",
            full_name="apollo.routing.CurveRange.start",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="apollo.routing.CurveRange.end",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_NODE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="lane_id",
            full_name="apollo.routing.Node.lane_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="length",
            full_name="apollo.routing.Node.length",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="left_out",
            full_name="apollo.routing.Node.left_out",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="right_out",
            full_name="apollo.routing.Node.right_out",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="cost",
            full_name="apollo.routing.Node.cost",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="central_curve",
            full_name="apollo.routing.Node.central_curve",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="is_virtual",
            full_name="apollo.routing.Node.is_virtual",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="road_id",
            full_name="apollo.routing.Node.road_id",
            index=7,
            number=8,
            type=9,
            cpp_type=9,
...
_EDGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="from_lane_id",
            full_name="apollo.routing.Edge.from_lane_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="to_lane_id",
            full_name="apollo.routing.Edge.to_lane_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cost",
            full_name="apollo.routing.Edge.cost",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="direction_type",
            full_name="apollo.routing.Edge.direction_type",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_EDGE_DIRECTIONTYPE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_GRAPH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="hdmap_version",
            full_name="apollo.routing.Graph.hdmap_version",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="hdmap_district",
            full_name="apollo.routing.Graph.hdmap_district",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="node",
            full_name="apollo.routing.Graph.node",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="edge",
            full_name="apollo.routing.Graph.edge",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
CurvePoint = _reflection.GeneratedProtocolMessageType(
    "CurvePoint",
    (_message.Message,),
    {"DESCRIPTOR": _CURVEPOINT, "__module__": "modules.routing.proto.topo_graph_pb2"},
)
_sym_db.RegisterMessage(CurvePoint)
CurveRange = _reflection.GeneratedProtocolMessageType(
    "CurveRange",
    (_message.Message,),
    {"DESCRIPTOR": _CURVERANGE, "__module__": "modules.routing.proto.topo_graph_pb2"},
)
_sym_db.RegisterMessage(CurveRange)
Node = _reflection.GeneratedProtocolMessageType(
    "Node",
    (_message.Message,),
    {"DESCRIPTOR": _NODE, "__module__": "modules.routing.proto.topo_graph_pb2"},
)
_sym_db.RegisterMessage(Node)
Edge = _reflection.GeneratedProtocolMessageType(
    "Edge",
    (_message.Message,),
    {"DESCRIPTOR": _EDGE, "__module__": "modules.routing.proto.topo_graph_pb2"},
)
_sym_db.RegisterMessage(Edge)
Graph = _reflection.GeneratedProtocolMessageType(
    "Graph",
    (_message.Message,),
    {"DESCRIPTOR": _GRAPH, "__module__": "modules.routing.proto.topo_graph_pb2"},
)
