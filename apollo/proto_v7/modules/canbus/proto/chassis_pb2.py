...
_CHASSIS = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_CHASSIS_DRIVINGMODE, _CHASSIS_ERRORCODE, _CHASSIS_GEARPOSITION],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
