...
_VECTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="columns",
            full_name="apollo.prediction.Vector.columns",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
...
_MATRIX = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="rows",
            full_name="apollo.prediction.Matrix.rows",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LAYER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="layer_input_dim",
            full_name="apollo.prediction.Layer.layer_input_dim",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="layer_output_dim",
            full_name="apollo.prediction.Layer.layer_output_dim",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="layer_input_weight",
            full_name="apollo.prediction.Layer.layer_input_weight",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="layer_bias",
            full_name="apollo.prediction.Layer.layer_bias",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="layer_activation_func",
            full_name="apollo.prediction.Layer.layer_activation_func",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_LAYER_ACTIVATIONFUNC],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
Layer = _reflection.GeneratedProtocolMessageType(
    "Layer",
    (_message.Message,),
    {"DESCRIPTOR": _LAYER, "__module__": "modules.prediction.proto.fnn_model_base_pb2"},
)
