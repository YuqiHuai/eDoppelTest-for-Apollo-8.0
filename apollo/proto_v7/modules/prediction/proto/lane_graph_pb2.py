...
LanePoint = _reflection.GeneratedProtocolMessageType(
    "LanePoint",
    (_message.Message,),
    {"DESCRIPTOR": _LANEPOINT, "__module__": "modules.prediction.proto.lane_graph_pb2"},
)
...
StopSign = _reflection.GeneratedProtocolMessageType(
    "StopSign",
    (_message.Message,),
    {"DESCRIPTOR": _STOPSIGN, "__module__": "modules.prediction.proto.lane_graph_pb2"},
)
...
LaneGraph = _reflection.GeneratedProtocolMessageType(
    "LaneGraph",
    (_message.Message,),
    {"DESCRIPTOR": _LANEGRAPH, "__module__": "modules.prediction.proto.lane_graph_pb2"},
)
