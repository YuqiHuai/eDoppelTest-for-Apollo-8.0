...
_VNVECTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="element",
            full_name="apollo.prediction.VNVector.element",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
...
_POLYLINE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="vector",
            full_name="apollo.prediction.Polyline.vector",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="p_id_x",
            full_name="apollo.prediction.Polyline.p_id_x",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="p_id_y",
            full_name="apollo.prediction.Polyline.p_id_y",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_CARPOSITION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="apollo.prediction.CarPosition.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="apollo.prediction.CarPosition.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="phi",
            full_name="apollo.prediction.CarPosition.phi",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.prediction.CarPosition.id",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_VECTORNETFEATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="car_position",
            full_name="apollo.prediction.VectorNetFeature.car_position",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="polyline",
            full_name="apollo.prediction.VectorNetFeature.polyline",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_WORLDCOORD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="pose",
            full_name="apollo.prediction.WorldCoord.pose",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
VNVector = _reflection.GeneratedProtocolMessageType(
    "VNVector",
    (_message.Message,),
    {"DESCRIPTOR": _VNVECTOR, "__module__": "modules.prediction.proto.vector_net_pb2"},
)
_sym_db.RegisterMessage(VNVector)
Polyline = _reflection.GeneratedProtocolMessageType(
    "Polyline",
    (_message.Message,),
    {"DESCRIPTOR": _POLYLINE, "__module__": "modules.prediction.proto.vector_net_pb2"},
)
_sym_db.RegisterMessage(Polyline)
CarPosition = _reflection.GeneratedProtocolMessageType(
    "CarPosition",
    (_message.Message,),
    {
...
VectorNetFeature = _reflection.GeneratedProtocolMessageType(
    "VectorNetFeature",
    (_message.Message,),
    {
...
WorldCoord = _reflection.GeneratedProtocolMessageType(
    "WorldCoord",
    (_message.Message,),
    {
