...
_OBSTACLECONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="obstacle_type",
            full_name="apollo.prediction.ObstacleConf.obstacle_type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.ObstacleConf.obstacle_status",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="priority_type",
            full_name="apollo.prediction.ObstacleConf.priority_type",
            index=2,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.ObstacleConf.interactive_tag",
            index=3,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="evaluator_type",
            full_name="apollo.prediction.ObstacleConf.evaluator_type",
            index=4,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="predictor_type",
            full_name="apollo.prediction.ObstacleConf.predictor_type",
            index=5,
            number=4,
            type=14,
            cpp_type=8,
...
_TOPICCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="adccontainer_topic_name",
            full_name="apollo.prediction.TopicConf.adccontainer_topic_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="container_topic_name",
            full_name="apollo.prediction.TopicConf.container_topic_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="evaluator_topic_name",
            full_name="apollo.prediction.TopicConf.evaluator_topic_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.TopicConf.localization_topic",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="perception_obstacle_topic",
            full_name="apollo.prediction.TopicConf.perception_obstacle_topic",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="perception_obstacles_topic_name",
            full_name="apollo.prediction.TopicConf.perception_obstacles_topic_name",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.TopicConf.planning_trajectory_topic",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.TopicConf.prediction_topic",
            index=7,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.TopicConf.storytelling_topic",
            index=8,
            number=9,
            type=9,
            cpp_type=9,
...
_PREDICTIONCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="topic_conf",
            full_name="apollo.prediction.PredictionConf.topic_conf",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="obstacle_conf",
            full_name="apollo.prediction.PredictionConf.obstacle_conf",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_OBSTACLECONF.fields_by_name[
    ...
    modules_dot_prediction_dot_proto_dot_feature__pb2._OBSTACLEPRIORITY_PRIORITY
)
_OBSTACLECONF.fields_by_name[
    "interactive_tag"
].enum_type = (
    modules_dot_prediction_dot_proto_dot_feature__pb2._OBSTACLEINTERACTIVETAG_INTERACTIVETAG
)
...
ObstacleConf = _reflection.GeneratedProtocolMessageType(
    "ObstacleConf",
    (_message.Message,),
    {
...
TopicConf = _reflection.GeneratedProtocolMessageType(
    "TopicConf",
    (_message.Message,),
    {
...
PredictionConf = _reflection.GeneratedProtocolMessageType(
    "PredictionConf",
    (_message.Message,),
    {
