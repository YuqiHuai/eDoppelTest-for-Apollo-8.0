...
from ....modules.prediction.proto import (
    prediction_conf_pb2 as modules_dot_prediction_dot_proto_dot_prediction__conf__pb2,
)
from ....modules.prediction.proto import (
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        modules_dot_prediction_dot_proto_dot_prediction__conf__pb2.DESCRIPTOR,
        modules_dot_prediction_dot_proto_dot_scenario__pb2.DESCRIPTOR,
    ],
)
_DATAFORLEARNING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="category",
            full_name="apollo.prediction.DataForLearning.category",
            index=0,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.prediction.DataForLearning.id",
            index=1,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="apollo.prediction.DataForLearning.timestamp",
            index=2,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="features_for_learning",
            full_name="apollo.prediction.DataForLearning.features_for_learning",
            index=3,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="string_features_for_learning",
            full_name="apollo.prediction.DataForLearning.string_features_for_learning",
            index=4,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="apollo.prediction.DataForLearning.labels",
            index=5,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.DataForLearning.lane_sequence_id",
            index=6,
            number=6,
            type=5,
            cpp_type=1,
...
_LISTDATAFORLEARNING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.ListDataForLearning.data_for_learning",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PREDICTIONRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.prediction.PredictionResult.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="apollo.prediction.PredictionResult.timestamp",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="trajectory",
            full_name="apollo.prediction.PredictionResult.trajectory",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="obstacle_conf",
            full_name="apollo.prediction.PredictionResult.obstacle_conf",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="scenario",
            full_name="apollo.prediction.PredictionResult.scenario",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_LISTPREDICTIONRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.ListPredictionResult.prediction_result",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LISTFRAMEENV = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="frame_env",
            full_name="apollo.prediction.ListFrameEnv.frame_env",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_DATAFORTUNING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="category",
            full_name="apollo.prediction.DataForTuning.category",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.prediction.DataForTuning.id",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="apollo.prediction.DataForTuning.timestamp",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="values_for_tuning",
            full_name="apollo.prediction.DataForTuning.values_for_tuning",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="real_cost_value",
            full_name="apollo.prediction.DataForTuning.real_cost_value",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="lane_sequence_id",
            full_name="apollo.prediction.DataForTuning.lane_sequence_id",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.DataForTuning.adc_trajectory_point",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
_LISTDATAFORTUNING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.prediction.ListDataForTuning.data_for_tuning",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_FEATURES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="feature",
            full_name="apollo.prediction.Features.feature",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PREDICTIONRESULT.fields_by_name[
    "trajectory"
].message_type = modules_dot_prediction_dot_proto_dot_feature__pb2._TRAJECTORY
_PREDICTIONRESULT.fields_by_name[
    "obstacle_conf"
].message_type = (
    modules_dot_prediction_dot_proto_dot_prediction__conf__pb2._OBSTACLECONF
)
_PREDICTIONRESULT.fields_by_name[
    "scenario"
].message_type = modules_dot_prediction_dot_proto_dot_scenario__pb2._SCENARIO
_LISTPREDICTIONRESULT.fields_by_name[
    "prediction_result"
].message_type = _PREDICTIONRESULT
_LISTFRAMEENV.fields_by_name[
    "frame_env"
].message_type = modules_dot_prediction_dot_proto_dot_feature__pb2._FRAMEENV
_DATAFORTUNING.fields_by_name[
...
_FEATURES.fields_by_name[
    "feature"
].message_type = modules_dot_prediction_dot_proto_dot_feature__pb2._FEATURE
...
DataForLearning = _reflection.GeneratedProtocolMessageType(
    "DataForLearning",
    (_message.Message,),
    {
...
ListDataForLearning = _reflection.GeneratedProtocolMessageType(
    "ListDataForLearning",
    (_message.Message,),
    {
...
PredictionResult = _reflection.GeneratedProtocolMessageType(
    "PredictionResult",
    (_message.Message,),
    {
...
ListPredictionResult = _reflection.GeneratedProtocolMessageType(
...
ListFrameEnv = _reflection.GeneratedProtocolMessageType(
    "ListFrameEnv",
    (_message.Message,),
    {
...
DataForTuning = _reflection.GeneratedProtocolMessageType(
    "DataForTuning",
    (_message.Message,),
    {
...
ListDataForTuning = _reflection.GeneratedProtocolMessageType(
    "ListDataForTuning",
    (_message.Message,),
    {
