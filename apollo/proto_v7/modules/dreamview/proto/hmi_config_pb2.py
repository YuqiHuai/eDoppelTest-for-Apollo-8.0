...
_HMICONFIG_MODESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.dreamview.HMIConfig.ModesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.dreamview.HMIConfig.ModesEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_HMICONFIG_MAPSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.dreamview.HMIConfig.MapsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.dreamview.HMIConfig.MapsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_HMICONFIG_VEHICLESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.dreamview.HMIConfig.VehiclesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.dreamview.HMIConfig.VehiclesEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_HMICONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="modes",
            full_name="apollo.dreamview.HMIConfig.modes",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="maps",
            full_name="apollo.dreamview.HMIConfig.maps",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="vehicles",
            full_name="apollo.dreamview.HMIConfig.vehicles",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _HMICONFIG_MODESENTRY,
        _HMICONFIG_MAPSENTRY,
        _HMICONFIG_VEHICLESENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_VEHICLEDATA_DATAFILE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="source_path",
            full_name="apollo.dreamview.VehicleData.DataFile.source_path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="dest_path",
            full_name="apollo.dreamview.VehicleData.DataFile.dest_path",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_VEHICLEDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="data_files",
            full_name="apollo.dreamview.VehicleData.data_files",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
HMIConfig = _reflection.GeneratedProtocolMessageType(
    "HMIConfig",
    (_message.Message,),
    {
        "ModesEntry": _reflection.GeneratedProtocolMessageType(
            "ModesEntry",
            (_message.Message,),
            {
        ...
        "MapsEntry": _reflection.GeneratedProtocolMessageType(
            "MapsEntry",
            (_message.Message,),
            {
...
VehicleData = _reflection.GeneratedProtocolMessageType(
    "VehicleData",
    (_message.Message,),
    {
