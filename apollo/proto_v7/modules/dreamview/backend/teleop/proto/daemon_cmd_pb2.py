...
_DAEMONCMD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="modules.teleop.daemon.DaemonCmd.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="service",
            full_name="modules.teleop.daemon.DaemonCmd.service",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cmd",
            full_name="modules.teleop.daemon.DaemonCmd.cmd",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"start".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
...
DaemonCmd = _reflection.GeneratedProtocolMessageType(
    "DaemonCmd",
    (_message.Message,),
    {
