...
_RADAROBSTACLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="apollo.drivers.RadarObstacle.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.RadarObstacle.relative_position",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.RadarObstacle.relative_velocity",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rcs",
            full_name="apollo.drivers.RadarObstacle.rcs",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="moving_status",
            full_name="apollo.drivers.RadarObstacle.moving_status",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="apollo.drivers.RadarObstacle.width",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="length",
            full_name="apollo.drivers.RadarObstacle.length",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="apollo.drivers.RadarObstacle.height",
            index=7,
            number=8,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="theta",
            full_name="apollo.drivers.RadarObstacle.theta",
            index=8,
            number=9,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.RadarObstacle.absolute_position",
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="absolute_velocity",
            full_name="apollo.drivers.RadarObstacle.absolute_velocity",
            index=10,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="count",
            full_name="apollo.drivers.RadarObstacle.count",
            index=11,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="moving_frames_count",
            full_name="apollo.drivers.RadarObstacle.moving_frames_count",
            index=12,
            number=13,
            type=5,
            cpp_type=1,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_RADAROBSTACLE_STATUS, _RADAROBSTACLE_MOVINGSTATUS],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_RADAROBSTACLES_RADAROBSTACLEENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="apollo.drivers.RadarObstacles.RadarObstacleEntry.key",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="apollo.drivers.RadarObstacles.RadarObstacleEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_RADAROBSTACLES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="radar_obstacle",
            full_name="apollo.drivers.RadarObstacles.radar_obstacle",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.RadarObstacles.header",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="error_code",
            full_name="apollo.drivers.RadarObstacles.error_code",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_RADAROBSTACLES.fields_by_name[
    "radar_obstacle"
].message_type = _RADAROBSTACLES_RADAROBSTACLEENTRY
_RADAROBSTACLES.fields_by_name[
    "header"
...
RadarObstacle = _reflection.GeneratedProtocolMessageType(
    "RadarObstacle",
    (_message.Message,),
    {"DESCRIPTOR": _RADAROBSTACLE, "__module__": "modules.drivers.proto.radar_pb2"},
)
_sym_db.RegisterMessage(RadarObstacle)
RadarObstacles = _reflection.GeneratedProtocolMessageType(
    "RadarObstacles",
    (_message.Message,),
    {
        "RadarObstacleEntry": _reflection.GeneratedProtocolMessageType(
            "RadarObstacleEntry",
            (_message.Message,),
            {
