...
_POINTXYZIT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="apollo.drivers.PointXYZIT.x",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="apollo.drivers.PointXYZIT.y",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="z",
            full_name="apollo.drivers.PointXYZIT.z",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="intensity",
            full_name="apollo.drivers.PointXYZIT.intensity",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="apollo.drivers.PointXYZIT.timestamp",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
...
_POINTCLOUD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.PointCloud.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="frame_id",
            full_name="apollo.drivers.PointCloud.frame_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_dense",
            full_name="apollo.drivers.PointCloud.is_dense",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="point",
            full_name="apollo.drivers.PointCloud.point",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.PointCloud.measurement_time",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="apollo.drivers.PointCloud.width",
            index=5,
            number=6,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="apollo.drivers.PointCloud.height",
            index=6,
            number=7,
            type=13,
            cpp_type=3,
...
PointXYZIT = _reflection.GeneratedProtocolMessageType(
    "PointXYZIT",
    (_message.Message,),
    {"DESCRIPTOR": _POINTXYZIT, "__module__": "modules.drivers.proto.pointcloud_pb2"},
)
_sym_db.RegisterMessage(PointXYZIT)
PointCloud = _reflection.GeneratedProtocolMessageType(
    "PointCloud",
    (_message.Message,),
    {"DESCRIPTOR": _POINTCLOUD, "__module__": "modules.drivers.proto.pointcloud_pb2"},
)
