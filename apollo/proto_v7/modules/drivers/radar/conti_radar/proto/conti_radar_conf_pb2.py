...
_OUTPUTTYPE = _descriptor.EnumDescriptor(
    name="OutputType",
    full_name="apollo.drivers.conti_radar.OutputType",
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_RCSTHRESHOLD = _descriptor.EnumDescriptor(
    name="RcsThreshold",
    full_name="apollo.drivers.conti_radar.RcsThreshold",
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_CANCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.CanConf.can_card_parameter",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.CanConf.enable_debug_mode",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.CanConf.enable_receiver_log",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.CanConf.enable_sender_log",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_RADARCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.max_distance_valid",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.sensor_id_valid",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.radar_power_valid",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.output_type_valid",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.send_quality_valid",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.send_ext_info_valid",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.sort_index_valid",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.store_in_nvm_valid",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.ctrl_relay_valid",
            index=8,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.conti_radar.RadarConf.rcs_threshold_valid",
            index=9,
            number=10,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="max_distance",
            full_name="apollo.drivers.conti_radar.RadarConf.max_distance",
            index=10,
            number=11,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="sensor_id",
            full_name="apollo.drivers.conti_radar.RadarConf.sensor_id",
            index=11,
            number=12,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="output_type",
            full_name="apollo.drivers.conti_radar.RadarConf.output_type",
            index=12,
            number=13,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="radar_power",
            full_name="apollo.drivers.conti_radar.RadarConf.radar_power",
            index=13,
            number=14,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="ctrl_relay",
            full_name="apollo.drivers.conti_radar.RadarConf.ctrl_relay",
            index=14,
            number=15,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="send_ext_info",
            full_name="apollo.drivers.conti_radar.RadarConf.send_ext_info",
            index=15,
            number=16,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="send_quality",
            full_name="apollo.drivers.conti_radar.RadarConf.send_quality",
            index=16,
            number=17,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="sort_index",
            full_name="apollo.drivers.conti_radar.RadarConf.sort_index",
            index=17,
            number=18,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="store_in_nvm",
            full_name="apollo.drivers.conti_radar.RadarConf.store_in_nvm",
            index=18,
            number=19,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="rcs_threshold",
            full_name="apollo.drivers.conti_radar.RadarConf.rcs_threshold",
            index=19,
            number=20,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="input_send_interval",
            full_name="apollo.drivers.conti_radar.RadarConf.input_send_interval",
            index=20,
            number=21,
            type=4,
            cpp_type=4,
...
_CONTIRADARCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="can_conf",
            full_name="apollo.drivers.conti_radar.ContiRadarConf.can_conf",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="radar_conf",
            full_name="apollo.drivers.conti_radar.ContiRadarConf.radar_conf",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="radar_channel",
            full_name="apollo.drivers.conti_radar.ContiRadarConf.radar_channel",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
ContiRadarConf = _reflection.GeneratedProtocolMessageType(
    "ContiRadarConf",
    (_message.Message,),
    {
