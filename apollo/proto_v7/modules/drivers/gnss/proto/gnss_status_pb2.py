...
_STREAMSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.gnss.StreamStatus.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ins_stream_type",
            full_name="apollo.drivers.gnss.StreamStatus.ins_stream_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="rtk_stream_in_type",
            full_name="apollo.drivers.gnss.StreamStatus.rtk_stream_in_type",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="rtk_stream_out_type",
            full_name="apollo.drivers.gnss.StreamStatus.rtk_stream_out_type",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_INSSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.gnss.InsStatus.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GNSSSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.gnss.GnssStatus.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.gnss.GnssStatus.solution_completed",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.gnss.GnssStatus.solution_status",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="position_type",
            full_name="apollo.drivers.gnss.GnssStatus.position_type",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="num_sats",
            full_name="apollo.drivers.gnss.GnssStatus.num_sats",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
InsStatus = _reflection.GeneratedProtocolMessageType(
    "InsStatus",
    (_message.Message,),
    {
...
GnssStatus = _reflection.GeneratedProtocolMessageType(
    "GnssStatus",
    (_message.Message,),
    {
