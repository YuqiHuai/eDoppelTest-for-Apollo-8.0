...
_STREAM_SERIAL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="device",
            full_name="apollo.drivers.gnss.config.Stream.Serial.device",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="baud_rate",
            full_name="apollo.drivers.gnss.config.Stream.Serial.baud_rate",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_STREAM_TCP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="address",
            full_name="apollo.drivers.gnss.config.Stream.Tcp.address",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="port",
            full_name="apollo.drivers.gnss.config.Stream.Tcp.port",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_STREAM_UDP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="address",
            full_name="apollo.drivers.gnss.config.Stream.Udp.address",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="port",
            full_name="apollo.drivers.gnss.config.Stream.Udp.port",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_STREAM_NTRIP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="address",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.address",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="port",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.port",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="mount_point",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.mount_point",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="user",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.user",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="password",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.password",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="timeout_s",
            full_name="apollo.drivers.gnss.config.Stream.Ntrip.timeout_s",
            index=5,
            number=6,
            type=13,
            cpp_type=3,
...
_STREAM = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="push_location",
            full_name="apollo.drivers.gnss.config.Stream.push_location",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="type",
            full_name="apollo.drivers.gnss.config.Stream.type",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_NOVATELCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.drivers.gnss.config.NovatelConfig.imu_orientation",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_TF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="frame_id",
            full_name="apollo.drivers.gnss.config.TF.frame_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"world".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="child_frame_id",
            full_name="apollo.drivers.gnss.config.TF.child_frame_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"novatel".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="enable",
            full_name="apollo.drivers.gnss.config.TF.enable",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_CONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="data",
            full_name="apollo.drivers.gnss.config.Config.data",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="command",
            full_name="apollo.drivers.gnss.config.Config.command",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rtk_from",
            full_name="apollo.drivers.gnss.config.Config.rtk_from",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rtk_to",
            full_name="apollo.drivers.gnss.config.Config.rtk_to",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="login_commands",
            full_name="apollo.drivers.gnss.config.Config.login_commands",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="logout_commands",
            full_name="apollo.drivers.gnss.config.Config.logout_commands",
            index=5,
            number=6,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="novatel_config",
            full_name="apollo.drivers.gnss.config.Config.novatel_config",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ublox_config",
            full_name="apollo.drivers.gnss.config.Config.ublox_config",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rtk_solution_type",
            full_name="apollo.drivers.gnss.config.Config.rtk_solution_type",
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="imu_type",
            full_name="apollo.drivers.gnss.config.Config.imu_type",
            index=9,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="proj4_text",
            full_name="apollo.drivers.gnss.config.Config.proj4_text",
            index=10,
            number=11,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="tf",
            full_name="apollo.drivers.gnss.config.Config.tf",
            index=11,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="wheel_parameters",
            full_name="apollo.drivers.gnss.config.Config.wheel_parameters",
            index=12,
            number=13,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="gpsbin_folder",
            full_name="apollo.drivers.gnss.config.Config.gpsbin_folder",
            index=13,
            number=14,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_CONFIG_RTKSOLUTIONTYPE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
    oneofs=[
        _descriptor.OneofDescriptor(
            name="device_config",
            full_name="apollo.drivers.gnss.config.Config.device_config",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_STREAM.oneofs_by_name["type"].fields.append(_STREAM.fields_by_name["serial"])
_STREAM.fields_by_name["serial"].containing_oneof = _STREAM.oneofs_by_name["type"]
_STREAM.oneofs_by_name["type"].fields.append(_STREAM.fields_by_name["tcp"])
_STREAM.fields_by_name["tcp"].containing_oneof = _STREAM.oneofs_by_name["type"]
_STREAM.oneofs_by_name["type"].fields.append(_STREAM.fields_by_name["udp"])
_STREAM.fields_by_name["udp"].containing_oneof = _STREAM.oneofs_by_name["type"]
_STREAM.oneofs_by_name["type"].fields.append(_STREAM.fields_by_name["ntrip"])
...
_CONFIG.fields_by_name["novatel_config"].containing_oneof = _CONFIG.oneofs_by_name[
    "device_config"
]
_CONFIG.oneofs_by_name["device_config"].fields.append(
    _CONFIG.fields_by_name["ublox_config"]
)
_CONFIG.fields_by_name["ublox_config"].containing_oneof = _CONFIG.oneofs_by_name[
    "device_config"
]
...
Stream = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "Serial": _reflection.GeneratedProtocolMessageType(
            "Serial",
            (_message.Message,),
            {
        ...
        "Tcp": _reflection.GeneratedProtocolMessageType(
            "Tcp",
            (_message.Message,),
            {
        ...
        "Udp": _reflection.GeneratedProtocolMessageType(
            "Udp",
            (_message.Message,),
            {
        ...
        "Ntrip": _reflection.GeneratedProtocolMessageType(
            "Ntrip",
            (_message.Message,),
            {
...
NovatelConfig = _reflection.GeneratedProtocolMessageType(
    "NovatelConfig",
    (_message.Message,),
    {
...
UbloxConfig = _reflection.GeneratedProtocolMessageType(
    "UbloxConfig",
    (_message.Message,),
    {"DESCRIPTOR": _UBLOXCONFIG, "__module__": "modules.drivers.gnss.proto.config_pb2"},
)
_sym_db.RegisterMessage(UbloxConfig)
TF = _reflection.GeneratedProtocolMessageType(
    "TF",
    (_message.Message,),
    {"DESCRIPTOR": _TF, "__module__": "modules.drivers.gnss.proto.config_pb2"},
)
_sym_db.RegisterMessage(TF)
Config = _reflection.GeneratedProtocolMessageType(
    "Config",
    (_message.Message,),
    {"DESCRIPTOR": _CONFIG, "__module__": "modules.drivers.gnss.proto.config_pb2"},
)
