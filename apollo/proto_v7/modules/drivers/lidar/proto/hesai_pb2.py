...
_HESAISCANPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stamp",
            full_name="apollo.drivers.hesai.HesaiScanPacket.stamp",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="data",
            full_name="apollo.drivers.hesai.HesaiScanPacket.data",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_HESAISCAN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.hesai.HesaiScan.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="model",
            full_name="apollo.drivers.hesai.HesaiScan.model",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="firing_pkts",
            full_name="apollo.drivers.hesai.HesaiScan.firing_pkts",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="basetime",
            full_name="apollo.drivers.hesai.HesaiScan.basetime",
            index=3,
            number=4,
            type=4,
            cpp_type=4,
...
HesaiScanPacket = _reflection.GeneratedProtocolMessageType(
    "HesaiScanPacket",
    (_message.Message,),
    {
...
HesaiScan = _reflection.GeneratedProtocolMessageType(
    "HesaiScan",
    (_message.Message,),
    {"DESCRIPTOR": _HESAISCAN, "__module__": "modules.drivers.lidar.proto.hesai_pb2"},
)
