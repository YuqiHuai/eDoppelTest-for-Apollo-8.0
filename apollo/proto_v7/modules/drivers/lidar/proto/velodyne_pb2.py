...
_VELODYNEPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stamp",
            full_name="apollo.drivers.velodyne.VelodynePacket.stamp",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="data",
            full_name="apollo.drivers.velodyne.VelodynePacket.data",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_VELODYNESCAN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="apollo.drivers.velodyne.VelodyneScan.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="model",
            full_name="apollo.drivers.velodyne.VelodyneScan.model",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="mode",
            full_name="apollo.drivers.velodyne.VelodyneScan.mode",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="firing_pkts",
            full_name="apollo.drivers.velodyne.VelodyneScan.firing_pkts",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="positioning_pkts",
            full_name="apollo.drivers.velodyne.VelodyneScan.positioning_pkts",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="sn",
            full_name="apollo.drivers.velodyne.VelodyneScan.sn",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="basetime",
            full_name="apollo.drivers.velodyne.VelodyneScan.basetime",
            index=6,
            number=7,
            type=4,
            cpp_type=4,
...
VelodynePacket = _reflection.GeneratedProtocolMessageType(
    "VelodynePacket",
    (_message.Message,),
    {
...
VelodyneScan = _reflection.GeneratedProtocolMessageType(
    "VelodyneScan",
    (_message.Message,),
    {
