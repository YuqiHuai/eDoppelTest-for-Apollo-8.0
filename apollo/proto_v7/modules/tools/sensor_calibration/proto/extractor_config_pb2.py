...
_IOCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            default_value=b"tmp".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="output_path",
            full_name="IoConfig.output_path",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            label=2,
            has_default_value=True,
            default_value=b"extracted_data".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="IoConfig.start_timestamp",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"FLOAT_MIN".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="end_timestamp",
            full_name="IoConfig.end_timestamp",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
            label=1,
            has_default_value=True,
            default_value=b"FLOAT_MAX".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="main_sensor",
            full_name="IoConfig.main_sensor",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_CHANNELCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="description",
            full_name="ChannelConfig.description",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ChannelConfig.extraction_rate",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
...
_DATAEXTRACTIONCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="io_config",
            full_name="DataExtractionConfig.io_config",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="channels",
            full_name="DataExtractionConfig.channels",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="records",
            full_name="DataExtractionConfig.records",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
IoConfig = _reflection.GeneratedProtocolMessageType(
    "IoConfig",
    (_message.Message,),
    {
...
ChannelConfig = _reflection.GeneratedProtocolMessageType(
    "ChannelConfig",
    (_message.Message,),
    {
...
Records = _reflection.GeneratedProtocolMessageType(
    "Records",
    (_message.Message,),
    {
        "DESCRIPTOR": _RECORDS,
...
DataExtractionConfig = _reflection.GeneratedProtocolMessageType(
