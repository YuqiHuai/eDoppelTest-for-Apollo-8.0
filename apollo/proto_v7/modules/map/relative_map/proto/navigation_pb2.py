...
from .....modules.perception.proto import (
    perception_obstacle_pb2 as modules_dot_perception_dot_proto_dot_perception__obstacle__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        modules_dot_map_dot_proto_dot_map__pb2.DESCRIPTOR,
        modules_dot_perception_dot_proto_dot_perception__obstacle__pb2.DESCRIPTOR,
    ],
)
...
_NAVIGATIONPATH.fields_by_name[
    "path"
].message_type = modules_dot_common_dot_proto_dot_pnc__point__pb2._PATH
...
_MAPMSG.fields_by_name[
    "hdmap"
].message_type = modules_dot_map_dot_proto_dot_map__pb2._MAP
_MAPMSG.fields_by_name["navigation_path"].message_type = _MAPMSG_NAVIGATIONPATHENTRY
_MAPMSG.fields_by_name[
    "lane_marker"
].message_type = (
    modules_dot_perception_dot_proto_dot_perception__obstacle__pb2._LANEMARKERS
)
_MAPMSG.fields_by_name[
    "localization"
].message_type = (
