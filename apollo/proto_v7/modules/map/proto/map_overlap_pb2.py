...
LaneOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "LaneOverlapInfo",
    (_message.Message,),
    {"DESCRIPTOR": _LANEOVERLAPINFO, "__module__": "modules.map.proto.map_overlap_pb2"},
)
...
RSUOverlapInfo = _reflection.GeneratedProtocolMessageType(
    "RSUOverlapInfo",
    (_message.Message,),
    {"DESCRIPTOR": _RSUOVERLAPINFO, "__module__": "modules.map.proto.map_overlap_pb2"},
)
...
Overlap = _reflection.GeneratedProtocolMessageType(
    "Overlap",
    (_message.Message,),
    {"DESCRIPTOR": _OVERLAP, "__module__": "modules.map.proto.map_overlap_pb2"},
)
