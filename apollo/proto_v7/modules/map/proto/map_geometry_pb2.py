...
Polygon = _reflection.GeneratedProtocolMessageType(
    "Polygon",
    (_message.Message,),
    {"DESCRIPTOR": _POLYGON, "__module__": "modules.map.proto.map_geometry_pb2"},
)
_sym_db.RegisterMessage(Polygon)
LineSegment = _reflection.GeneratedProtocolMessageType(
    "LineSegment",
    (_message.Message,),
    {"DESCRIPTOR": _LINESEGMENT, "__module__": "modules.map.proto.map_geometry_pb2"},
)
_sym_db.RegisterMessage(LineSegment)
CurveSegment = _reflection.GeneratedProtocolMessageType(
    "CurveSegment",
    (_message.Message,),
    {"DESCRIPTOR": _CURVESEGMENT, "__module__": "modules.map.proto.map_geometry_pb2"},
)
_sym_db.RegisterMessage(CurveSegment)
Curve = _reflection.GeneratedProtocolMessageType(
    "Curve",
    (_message.Message,),
    {"DESCRIPTOR": _CURVE, "__module__": "modules.map.proto.map_geometry_pb2"},
)
