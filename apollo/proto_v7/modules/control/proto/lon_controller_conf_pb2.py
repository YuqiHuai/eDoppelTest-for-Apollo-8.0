...
from ....modules.control.proto import (
    pid_conf_pb2 as modules_dot_control_dot_proto_dot_pid__conf__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        modules_dot_control_dot_proto_dot_calibration__table__pb2.DESCRIPTOR,
        modules_dot_control_dot_proto_dot_leadlag__conf__pb2.DESCRIPTOR,
        modules_dot_control_dot_proto_dot_pid__conf__pb2.DESCRIPTOR,
    ],
)
_FILTERCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cutoff_freq",
            full_name="apollo.control.FilterConf.cutoff_freq",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_LONCONTROLLERCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ts",
            full_name="apollo.control.LonControllerConf.ts",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="brake_minimum_action",
            full_name="apollo.control.LonControllerConf.brake_minimum_action",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="throttle_minimum_action",
            full_name="apollo.control.LonControllerConf.throttle_minimum_action",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="speed_controller_input_limit",
            full_name="apollo.control.LonControllerConf.speed_controller_input_limit",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="station_error_limit",
            full_name="apollo.control.LonControllerConf.station_error_limit",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="preview_window",
            full_name="apollo.control.LonControllerConf.preview_window",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="standstill_acceleration",
            full_name="apollo.control.LonControllerConf.standstill_acceleration",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="station_pid_conf",
            full_name="apollo.control.LonControllerConf.station_pid_conf",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="low_speed_pid_conf",
            full_name="apollo.control.LonControllerConf.low_speed_pid_conf",
            index=8,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="high_speed_pid_conf",
            full_name="apollo.control.LonControllerConf.high_speed_pid_conf",
            index=9,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="switch_speed",
            full_name="apollo.control.LonControllerConf.switch_speed",
            index=10,
            number=11,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="reverse_station_pid_conf",
            full_name="apollo.control.LonControllerConf.reverse_station_pid_conf",
            index=11,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="reverse_speed_pid_conf",
            full_name="apollo.control.LonControllerConf.reverse_speed_pid_conf",
            index=12,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="pitch_angle_filter_conf",
            full_name="apollo.control.LonControllerConf.pitch_angle_filter_conf",
            index=13,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="reverse_station_leadlag_conf",
            full_name="apollo.control.LonControllerConf.reverse_station_leadlag_conf",
            index=14,
            number=15,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="reverse_speed_leadlag_conf",
            full_name="apollo.control.LonControllerConf.reverse_speed_leadlag_conf",
            index=15,
            number=16,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.control.LonControllerConf.calibration_table",
            index=16,
            number=17,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="apollo.control.LonControllerConf.enable_reverse_leadlag_compensation",
            index=17,
            number=18,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="switch_speed_window",
            full_name="apollo.control.LonControllerConf.switch_speed_window",
            index=18,
            number=19,
            type=1,
            cpp_type=5,
...
_LONCONTROLLERCONF.fields_by_name[
    "station_pid_conf"
].message_type = modules_dot_control_dot_proto_dot_pid__conf__pb2._PIDCONF
_LONCONTROLLERCONF.fields_by_name[
    "low_speed_pid_conf"
].message_type = modules_dot_control_dot_proto_dot_pid__conf__pb2._PIDCONF
_LONCONTROLLERCONF.fields_by_name[
...
_LONCONTROLLERCONF.fields_by_name[
    ...
    modules_dot_control_dot_proto_dot_calibration__table__pb2._CONTROLCALIBRATIONTABLE
)
...
FilterConf = _reflection.GeneratedProtocolMessageType(
    "FilterConf",
    (_message.Message,),
    {
...
LonControllerConf = _reflection.GeneratedProtocolMessageType(
    "LonControllerConf",
    (_message.Message,),
    {
