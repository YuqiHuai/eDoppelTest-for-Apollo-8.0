...
_LEADLAGCONF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="innerstate_saturation_level",
            full_name="apollo.control.LeadlagConf.innerstate_saturation_level",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="alpha",
            full_name="apollo.control.LeadlagConf.alpha",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="beta",
            full_name="apollo.control.LeadlagConf.beta",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="tau",
            full_name="apollo.control.LeadlagConf.tau",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
LeadlagConf = _reflection.GeneratedProtocolMessageType(
    "LeadlagConf",
    (_message.Message,),
    {
